            ...
            <body>
                <div class="content">
                    <div class="field">
                        ...
                        <a href="https://skilllearn.online/newpassword?token=${token}"><button>New Password</button></a>
                    </div>
                </div>
            </body>
                ...
                <div class="content">
                    <div class="field">
                        ...
                        <p>We received a request to reset the password for your Skill-Learn account. If you didn't initiate this request,
                            please ignore this email.</p>
                        <p class="last">To reset your password, click the button above:</p>
                        <a href="https://skilllearn.online/professional/newpassword?token=${token}"><button>New Password</button></a>
                    </div>
                </div>
            </body>
